...
def load_products():
    ...
    return {
        '1': {
            'name': 'Chaser Balance Peach 30ml 50mg💙',
            'price': 15,
            'description': 'Це м\'який і соковитий смак стиглого персика, який наповнює кожну затяжку легкою солодкістю та фруктовою свіжістю. Чудовий вибір для поціновувачів натуральних і ніжних смаків на щодень.',
            'image': 'https://i.ibb.co/CssDQBTt/Chaser-Balance-Peach-30ml-50mg.png'
        },
        '2': {
            'name': '🍔 Бургер Делюкс',
            'price': 120,
            'description': 'Соковитий бургер з яловичиною',
            'image': 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=800'
        },
        '3': {
            'name': '🍣 Суші сет',
            'price': 250,
            'description': '12 шт. асорті суші',
